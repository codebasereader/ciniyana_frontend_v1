/**
 * Off the Camera helpers — slug, form mapping, validation.
 */
...
export function validateOffTheCameraFields(fields, { requireImage, hasExistingImage }) {
  const errors = {}
