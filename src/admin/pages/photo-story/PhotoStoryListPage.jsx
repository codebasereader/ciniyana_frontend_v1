...
export default function PhotoStoryListPage() {
  ...
  const handleDelete = async (post) => {
    ...
    try {
      await deletePhotoStoryPost(post.id)
  ...
  const handleSaveOrder = async (orderedIds) => {
    setSavingOrder(true)
    try {
      const updated = await reorderPhotoStoryPosts(orderedIds)
      setPosts(updated)
      invalidatePhotoStoryCache()
            ...
            >
              ...
              <div className="p-3">
                ...
                <div className="mt-3 flex gap-2">
                  <Link
                    to={`/admin/photo-story/${post.id}/edit`}
