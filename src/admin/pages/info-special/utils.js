/**
 * Info Special helpers — slug, form mapping, validation.
 */
...
export function postToFormFields(post) {
  ...
  return {
    ...
    galleryMode: post.galleryMode || 'carousel',
...
export function validateInfoSpecialFields(fields, { requireImage, hasExistingImage }) {
  const errors = {}
