...
import InfoSpecialForm from './components/InfoSpecialForm'
import { galleryFromPost, postToFormFields } from './utils'
import FormPageHeader from '../../components/FormPageHeader'

export default function InfoSpecialFormPage() {
  const { id } = useParams()
  ...
  const handleSubmit = async (fields, imageFile, gallerySlots, options = {}) => {
    ...
    try {
      if (isEdit) {
        ...
        await createInfoSpecialPost(fields, imageFile, gallerySlots, options)
      }
      invalidateInfoSpecialCache()
      navigate('/admin/info-special', { replace: true })
    } catch (err) {
  ...
  const goBack = () => navigate('/admin/info-special')
